...
import com.entity.ReportFile;
	...
	public class SendEmail {
	    ...
	    public static List<ReportFile>   traverseFolder2(String path) {
	    	List<ReportFile> fileslist=new ArrayList<ReportFile>();
	                ...
	                for (File file2 : files) {
	                    if (file2.isDirectory()) {
	                       ...
	                       // System.out.println("路径是 "+file2.getAbsolutePath());
	                        ...
	                        reportFile.setFile(file2.getName());
	                        reportFile.setAbsolutepath(file2.getAbsolutePath());
	                        fileslist.add(reportFile);
	                    }
	                }
	            }
	        } else {
	    ...
	    public static void main(String[] args) throws UnsupportedEncodingException {
	        ...
	        props.put("mail.user", "jasonxu@baofengrose.com");//发信地址
	        // 访问SMTP服务时需要提供的密码(在控制台选择发信地址进行设置)
	        props.put("mail.password", "MUsen861015");
...
//	        mailSession.setDebug(true);
	        ...
	        InternetAddress to = new InternetAddress("jasonxu@can-dao.com");//收件人邮件地址
	        ...
	        String ccUser = "jasonxu@can-dao.com";//抄送邮箱
	            // 设置多个抄送地址
	            ...
	            String bccUser = "jasonxu@can-dao.com";//密送邮箱
	            // 设置多个密送地址
	        ...
	        // 消息
	        messageBodyPart.setText("消息：请建超，由龙，阿ben各位尽快处理，谢谢~！");
	        // 创建多重消息
	        Multipart multipart = new MimeMultipart();
	        // 设置文本消息部分
	        multipart.addBodyPart(messageBodyPart);
	        // 附件部分
	        List <ReportFile> listfiles=SendEmail.traverseFolder2(reportPath);;
	        for(int i=0;i<listfiles.size();i++) {
		        ...
		        messageBodyPart.setFileName(MimeUtility.encodeText(listfiles.get(i).getFile()));
