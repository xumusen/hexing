...
public class MysqlJdbc {
	public static void main(String args[]) {
		...
		try {
			...
			ResultSet rs = stmt.executeQuery("	SELECT * FROM log0701 WHERE action_name IN ('candao.order.postDineInOrder','candao.order.postDineInStatus','candao.retail.order')\r\n" + 
					" 	");
