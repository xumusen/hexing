...
public class ComparePos {
	...
	private final static String first="2021-01-01";
	private final static String last="2021-01-31";
	...
	//	String begintime=TimeUtils.getToday("yyyy-MM-dd")+" 08:00:00";
	//	DataGatherLocal.reLoadFile("2021-01-25 00:00:00");
...
//我注释了GetOrderInfoSum.getorderinfoYb(first,last);、GetOrderDiff.getYborderdifff(first,last);   Data 	getPospalDiff
}
