...
public class GetFooSum {
	...
	public static void getFooSum(String begindate,String lastdate,String storeid) {
		
		try {
			OrderInfoSum.truncateOrderInfoFoo();//清空现有的数据
	...
	public static void getFooXiuCanSum(String begindate,String lastdate,String storeid) {
	...
	public static void main(String[] args) {
		...
		//getFooSum("2020-12-01","2020-12-31","YS010199");  //读取中台外卖订单
		getFooXiuCanSum("2020-12-01","2020-12-31","YS010199"); //读取中台小程序订单
	}
