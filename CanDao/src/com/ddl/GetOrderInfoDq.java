...
public class GetOrderInfoDq {
    ...
    public static void orderinfoDq(String storeid,String orderdate) throws Exception {
        ...
        String checkEveryDay="select * from test.order_info where storeid ='"+storeid+"' and fromtype=94  and trim(orderdate) ='"+orderdate+"'  ";
    ...
    public static void orderinfoDq(String storeid,String begindate,String enddate) throws Exception {
        ...
        String checkEveryDay="select * from test.order_info where storeid ='"+storeid+"' and fromtype=94 and trim(orderdate) >='"+begindate+"' and trim(orderdate) <='"+enddate+"'  ";
    ...
    public static void orderinfoDqYb(String storeid,String orderdate) throws Exception {

    	 String checkEveryDay="select * from test.order_info where storeid ='"+storeid+"' and trim(orderdate) ='"+orderdate+"' and fromtype=108 ";
    ...
    public static void excuteyb(String storeid,String orderdate) throws Exception {
    	GetOrderInfoDq getOrderInfoDq=new GetOrderInfoDq();
    	getOrderInfoDq.init();
		GetOrderInfoDq.orderinfoDqYb(storeid,orderdate);
		getOrderInfoDq.destory();
    }
    public static void main(String[] args) throws Exception {
		...
		getOrderInfo.orderinfoDqYb("YS451019","2020-12-01");
