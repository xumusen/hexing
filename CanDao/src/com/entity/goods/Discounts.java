...
public class Discounts {
	...
	public static void insertDiscount(String orderid,Discounts discounts,String orderDate,String orderTime)throws SQLException{
	    //首先拿到数据库的连接
	...
	*/	        
	    String sql=""+
	    		...
	    		"(code,pid,vendor,num,[type],childType,title,[content],price,totalAmount,thirdSubsidy,merchantSubsidy,orderid,orderDate,orderTime)"+
	    		"values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
	   // System.out.println(sql);
	    ...
	    psmt.setString(14, orderDate);
	    psmt.setString(15, orderTime);
