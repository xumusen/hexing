...
public static void insertCombos(String orderid,Combos combos,String fid,String fnum,String orderdate)throws SQLException{
    //首先拿到数据库的连接
...
*/	        
    String sql=""+
    		"INSERT INTO combos"+
    		"(pid,name,num,price,addPrice,orderid,fid,fnum,orderdate)"+
    		"values(?,?,?,?,?,?,?,?,?)";
