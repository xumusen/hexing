...
public class Category {
	...
	public static void insertCategory(String orderid,Category category,String pid)throws SQLException{
	    //首先拿到数据库的连接
	...
	*/	        
	   ...
	   // System.out.println(sql);
	    ...
	    //先对应SQL语句，给SQL语句传递参数
	    psmt.setString(1, category.getId());
	    psmt.setString(2, category.getTitle());
