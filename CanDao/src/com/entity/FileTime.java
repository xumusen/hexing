...
public class FileTime {
	...
	public static void insertFileTime(FileTime fileTime)throws SQLException{
	    //首先拿到数据库的连接
	    Connection conn=DBUtil.getConnection();
	    String sql="INSERT INTO [dbo].[filetime]\r\n" + 
	    		"           ([storeid]\r\n" + 
	    		"           ,[orderdate]\r\n" + 
	    		"           ,[ordertime]\r\n" + 
	    		"           ,[uploadtime]\r\n" + 
	...
	public static void insertFileTimeYbT(FileTime fileTime)throws SQLException{
	    //首先拿到数据库的连接
	    Connection conn=DBUtil.getConnection();
	    String sql="INSERT INTO [dbo].[filetimeYbT]\r\n" + 
	    		"           ([storeid]\r\n" + 
	    		"           ,[orderdate]\r\n" + 
	    		"           ,[ordertime]\r\n" + 
	    		"           ,[uploadtime]\r\n" + 
...
public static int truncatefiletimeYbT()throws SQLException{
	  
    Connection conn=DBUtil.getConnection();
   String sql="TRUNCATE TABLE filetimeYbT";
    PreparedStatement psmt = conn.prepareStatement(sql);
    //执行SQL语句
    int result=psmt.executeUpdate();
   // conn.close();
    System.out.println("filetimeYbT 已经被清空了");
    return result;
}
public static int truncatefiletime()throws SQLException{
	  
    Connection conn=DBUtil.getConnection();
   String sql="TRUNCATE TABLE filetime";
    PreparedStatement psmt = conn.prepareStatement(sql);
    //执行SQL语句
    int result=psmt.executeUpdate();
   // conn.close();
    System.out.println("filetime 已经被清空了");
    return result;
}
}
