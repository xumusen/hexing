...
public class OrderDiffYb {
	...
	public static void insertOrderDiffYb(OrderDiffYb orderDiff)throws SQLException{
	    //首先拿到数据库的连接
	    Connection conn=DBUtil.getConnection();
	    String sql="INSERT INTO [dbo].[orderDiffYb]\r\n" + 
	    		"           ([PosStore]\r\n" + 
	    		"           ,[PosUploaddatetime]\r\n" + 
	    		"           ,[PosRef]\r\n" + 
	    		"           ,[PosAmt]\r\n" + 
	...
	public static int truncateOrderDiffYb()throws SQLException{
		  
	    Connection conn=DBUtil.getConnection();
	   String sql="TRUNCATE TABLE orderDiffYb";
	    PreparedStatement psmt = conn.prepareStatement(sql);
	    //执行SQL语句
	    int result=psmt.executeUpdate();
	   // conn.close();
	    System.out.println("orderDiffYb 已经被清空了");
	    return result;
	}
