...
public class OTime {
	...
	public static void insertFileTime(OTime fileTime)throws SQLException{
	    //首先拿到数据库的连接
	    Connection conn=DBUtil.getConnection();
	    String sql="INSERT INTO [dbo].[otime]\r\n" + 
	    		"           ([storeid]\r\n" + 
	    		"           ,[orderdate]\r\n" + 
	    		"           ,[ordertime]\r\n" + 
	    		"           ,[uploadtime]\r\n" + 
...
public static int truncatefiletime()throws SQLException{
    ...
    Connection conn=DBUtil.getConnection();
   String sql="TRUNCATE TABLE otime";
    PreparedStatement psmt = conn.prepareStatement(sql);
    //执行SQL语句
    int result=psmt.executeUpdate();
   // conn.close();
    System.out.println("otime 已经被清空了");
    return result;
}
}
