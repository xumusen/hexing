...
public class PaymentDetails {
	...
	public static void insertPaymentDetails(String orderid,PaymentDetails paymentDetails)throws SQLException{
	        //首先拿到数据库的连接
...
*/	        
	        String sql=""+
	        		...
	        		"(orderid,payType,[type],posType,posName,typeName,[money],tradeNo,code)"
	        		+ "VALUES(?,?,?,?,?,?,?,?,?)";
