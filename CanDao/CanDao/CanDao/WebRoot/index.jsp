...
<script language="javascript">
	function sel() {
		...
		var time1=document.thisform.gettime.value;
		//alert(time1);
...
<!-- 
	...
	-->
	<form name="thisform" method="post" action="/CanDao/servlet/EchoForm">
	<!-- 	方法名<input type="text" name="actionName" value="candao.orderStandard.postOrder"><br/> --> 
		...
		门店ID<input type="text" name="storeId" value="123">
		姓名<input type="text" name="name" value="木森"><br/>
		电话<input type="text" name="phone" value="13800138000">
		备注<input type="text" name="userNote" value="加糖，加奶"><br/>
		...
		订单号<input type="text" name="invoiceDesc" value="广州餐道信息科技有限公司"><br/>
		...
		地址<input type="text" name="address" value="达信大厦"><br/>
		餐品1<br/>
		餐品ID<input type="text" name="pid" value="9684"><br/>
		餐品数量<input type="text" name="number" value="1"><br/>
